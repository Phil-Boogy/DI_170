...
# function that takes players move AND validates it
# def o_player_move():
#     column_move = int(input ("Tell me which column number you want: "))
#     row_move = int(input ("Tell me which row number you want: "))
#     if spaces [column_move-1] [row_move-1] == " ":
#         spaces [column_move-1] [row_move-1] = "O"
#     board()
...
#     row_move = int(input ("Tell me which row number you want: "))
#     if spaces [column_move-1] [row_move-1] == " ":
#         spaces [column_move-1] [row_move-1] = "X"
#     board()
...
# def ready_for_school (child):
#     if breakfast_finished = false:
#         eat
#     else:
#         brush teeth
